TranslationsEN = {
        ...
        racing_desc = "Here you can see active races and available races to join. If a race has vehicle class limitations you can still join if your class is lower. Automated races requires at least 2 participants to start.",
        ...
        only_saved_tempo = "Results with only one racer are only saved temporarily, however, the best times and records are still saved in Track Records.",
        available = "Available",
        ...
        bounties_desc_2 = 'After a bounty has been claimed you can not claim it again, but if you beat your own previous time you will get a payout.',
        ...
        creator = "Creator",
        crew = "Crew",
        not_in_crew_subtitle = "You are not currently in a racing crew. Create or join one to access crew features.",
        ...
        currency_text = "$",
        driftResults = "Drift Challenge Results",
        drift_challenge_new_joiner = " has joined the Drift Challenge!",
        current = "Current",
        ...
        deny = "Deny",
        drift = 'Drift',
        driftChallenge_title = 'Drift Challenge',
        driftChallenge_subtitle = 'Challenge nearby racers to a drift competition! Invite the closest racers to join your drift challenge. After a short countdown, the challenge begins and racers will compete to achieve the highest drift score within the time limit. The racer with the highest score at the end wins!',
        description = 'Description',
        description_hint = 'A short description of the track',
        disallow_drift = "Disallow Drift Races",
        ...
        drift_penalty = "Drift Score penalty applied for taking long between checkpoints",
        drift_race = "Drift Race",
        ...
        join_race = "Join Race",
        joining_expired = "Expired or Started",
        kick_member = "Kick crew member",
        ...
        leave_driftChallenge = "Leave current Drift Challenge",
        driftChallenge_invite = 'Drift Challenge invitation',
        in_driftChallenge = "In a Drift Challenge",
        drift_challenge_invite = 'You have a Drift Challenge invitation',
        drift_challenge_you_won = "You won the Drift Challenge",
        drift_challenge_you_lost = "You lost the Drift Challenge",
        drift_challenge_must_be_driver = "You must be the driver of the vehicle to start a Drift Challenge",
        drift_challenge_invite_none = "No one nearby to invite to the Drift Challenge",
        leave_race = "Leave Race",
        left_crew = 'Left racing crew',
        length = "Length",
        manage = "Manage",
        ...
        no_races_subtitle = "There are currently no active races but you can host one or check back later.",
        no_results = "No Results to browse yet",
        no_track_found = "No track found with id:",
        no_track_stats = "No track stats available yet",
        no_track_stats_description = "There are no stats available yet. Get racing!",
        ...
        toggle_casual_drifting ='Toggle Casual Drifting',
