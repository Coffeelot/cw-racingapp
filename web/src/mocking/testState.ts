...
import { ActiveRace, DriftInfo, Race, Racer, Track } from "../store/types";
import { translations } from "./translations";

const currentCrewName = "Coffee Sippers";
const currentRacerAuth = "master";
const currentRacerName = "CoffeeRacer";
...
export const testState = {
  ...
  baseData: { 
    data: {
      currentCrewName: currentCrewName,
      ...
      cryptoType: "RAC",
      currentCrypto: 0,
      currentRacerAuth: currentRacerAuth,
      currentRacerName: currentRacerName,
      currentRanking: 0,
...
export const driftInfoMocked: DriftInfo = {
    latestDriftScore: 869,
    score: 2000,
    multiplier: 10,
    isDrifting: true,
    driftAngle: 69,
