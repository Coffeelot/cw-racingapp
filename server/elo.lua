            ...
            if i ~= j then
                ...
                if crew.averageTime < opponent.averageTime then
                    ...
                    if rankDifference > 0 then -- if your rank is higher than opponent
                        scoreDifference = scoreDifference * modifiers.winAgainstLowerRankMod *scalingFactor  -- Lesser impact for higher rank
                    else
                        scoreDifference = scoreDifference * modifiers.winAgainstLowerRankMod   -- Greater impact for lower rank
                    end
...
if useDebug then -- Example input for testing
    ...
    -- Crew
    for team, teamData in pairs(crewRes) do
